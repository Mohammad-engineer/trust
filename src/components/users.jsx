    ...
    <ThemeProvider theme={defaultTheme}>
      <Grid container component="main" sx={{ height: "100vh" }}>
        ...
        <Grid item xs={false} sm={4} md={2} sx={{ backgroundColor: "#ffffff" }}>
          <Box className="project_sidebar">
            <Box className="pr_left_col">
        ...
        >
          ...
          >
            <Box className={styles.users_header}>
              <Typography variant="h3" sx={{fontSize:'25px',mb:1}}>Users Management</Typography>
            </Box>

            <div role="presentation" onClick={handleClick} style={{marginBottom:'10px'}}>
              <Breadcrumbs aria-label="breadcrumb">
                ...
                <span>
                  <PeopleAltIcon sx={{ mr: 0.5 }} fontSize="inherit" />
                  Users
                </span>
              </Breadcrumbs>
            </div>
